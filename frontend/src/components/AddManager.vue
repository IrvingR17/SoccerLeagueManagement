<template>
    <div>
        <div class="info">
                <h2>Registrar Representante de Equipo</h2>
                <h5>Ingresa los campos para dar de alta un nuevo representante</h5>
                <div class="form">
                    <b-form @submit.prevent="addManager()">
    ...
    methods: {
        async addManager() {
            const data = { first_name: this.first_name, last_name: this.last_name, phone_number: this.phone_number, 
                           is_manager: this.manager_status, email: this.email, password: this.password, re_password: this.repassword };
